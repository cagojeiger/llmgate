...
| result event | `metadata_only` 기본값, `redacted`/`full` 명시 선택 | consumer별 export 승인과 retention/파기 증적 필요 |
...
| 우선순위 | 항목 | 이유 |
|---|---|---|
| P0 | result event retention | 원문 request/response 경계는 mode/redaction으로 축소됨. 보관/파기 증적은 남음 |
